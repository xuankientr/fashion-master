...
<head>
  ...
  <title>Login</title>
  <link rel="icon" href="../assets\images\logo\logo-adam-store-removebg-preview.png" sizes="32x32">
  <!-- inject:css -->
  ...
  <div class="ui container centered grid">
    <div class="five wide computer sixteen wide tablet sixteen wide phone column" style="margin-top: 10%;">
        <div class="ui segment">
          <img class="ui centered medium image" src="../assets\images\logo\logo-adam-store-removebg-preview.png" alt=""><br>
          <div class="ui form">
