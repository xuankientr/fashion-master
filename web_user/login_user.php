...
<div class="axil-signin-area">
    ...
    <div class="signin-header">
        <div class="row align-items-center">
            <div class="col-sm-4">
                <a href="fashionApp.php" class="site-logo"><img style="width:300px;" src="../assets/images/logo/logo-adam-store-removebg-preview.png" alt="logo"></a>
            </div>
            <div class="col-sm-8">
        ...
        <div class="col-lg-6 offset-xl-2">
            <div class="axil-signin-form-wrap">
                <div class="axil-signin-form">
                    <h3 class="title">Sign in to Adam Store.</h3>
