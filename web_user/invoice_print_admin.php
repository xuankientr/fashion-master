...
<main class='invoice'>
  <div class='invoice-wrapper'>
    <img
      src='../assets/images/logo/logo-adam-store-removebg-preview.png'
      alt='logo' class='invoice-logo'>
    <div class='invoice-company'>
      <h2 class='invoice-company-name'>Adam Store.</h2>
      <p class='invoice-company-address'>
        <span>Dien Bien Phu Street,</span>
        <span>Da Nang, VietNam</span>
        <span>vtc@gmail.com</span>
      </p>
    </div>
  </div>
  <div class='invoice-wrapper'>
