                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="axil-footer-widget">
                            ...
                            <div class="inner">
                                <p>Dien Bien Phu Street,
                                   Da Nang, <br>
                                    Viet Nam.
                                </p>
                                <ul class="support-list-item">
                                    <li><a href="20522000@gm.uit.edu.vn"><i
                                                class="fal fa-envelope-open"></i>xuankientr@gmail.com</a></li>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="axil-footer-widget">
                            <h5 class="widget-title">Project</h5>
                            <div class="inner">
                                <ul>
                                    <li><a>Trinh Xuan Kien - SEK23</a></li>
                                    <li><a href="https://www.figma.com/file/hP8yLSFgwHDQFOx6kgKqUI/Fashion-Web-UI%2FUX?node-id=0%3A1&t=pNkmhqDvo2T8ANsl-1">Theme Figma</a></li>
